...
public class LunarDate :NSObject{
    ...
    public func getDate() throws -> Date
    {
        ...
        if !haveLeapMonth || lunarMonth < leapMonth{
            ...
            let monthDays = LunarDate.getChineseMonthDays(lunarMonth, lunarMonth)
        ...
        else
        {
            ...
            if lunarMonth > leapMonth
            {
                ...
                let monthDays = LunarDate.getChineseMonthDays(lunarYear, lunarDay)
    ...
    public var lunarMonthText : String
        ...
        get
        {
            return LunarDate.getLunarMonthTextByValue(lunarMonth)
        }
    }
